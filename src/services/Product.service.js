...
const getProductsWithOrdersData = () => {
    return [
        {
            id: '1000',
            code: 'f230fh0g3',
...
export const getProductsMini = () => {
    return Promise.resolve(getProductsData().slice(0, 5));
};

export const getProductsSmall = () => {
    return Promise.resolve(getProductsData().slice(0, 10));
};
...
export const getProductsWithOrdersSmall = () => {
    return Promise.resolve(getProductsWithOrdersData().slice(0, 10));
};

export const getProductsWithOrders = () => {
    return Promise.resolve(getProductsWithOrdersData());
};
