...
<template>
        ...
        <template #title>
            <div>
                ...
                <p class="mt-2 text-sm sm:text-base mx-auto sm:mx-0 mb-0">
                    These category items identify Expenses.
                </p>
            </div>
        </template>
        <template #actions>
    ...
    <Card class="py-3 px-2">
        <template #content>
            ...
            >
                ...
                <template #empty> No expense categories found. </template>
                <Column
                    class="w-[30rem]"
                    :sortable="true"
                    field="display_name"
    ...
    <BaseDialog
        ...
        :header="isEditMode ? 'Edit Expense Category' : 'New Expense Category'"
    ...
    <Confirmation
        ...
        :content="`Are you sure you want to make this expense category ${isItemActive ? 'inactive' : 'active'}?`"
