...
const exportMenuItems = [
    {
        ...
        command: () => ''
        // command: () =>
        //     exportData({ table: 'customer_financials', format: 'excel' })
    },
    {
        icon: 'pi pi-file-pdf',
        label: 'To PDF',
        command: () => ''
        // command: () =>
        //     exportData({ table: 'customer_financials', format: 'pdf' })
    }
];
...
const getItems = async () => {
    try {
        ...
        const res = await customerStore.searchFinancials(payload, params);
