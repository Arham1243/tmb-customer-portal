...
const exportMenuItems = [
    {
        ...
        command: () => ''
        // command: () =>
        //     exportData({ table: 'billing_history', format: 'excel' })
    },
    {
        icon: 'pi pi-file-pdf',
        label: 'To PDF',
        command: () => ''
        // command: () =>
        //     exportData({ table: 'billing_history', format: 'pdf' })
    }
];
...
<template>
    ...
    >
        ...
        <Column :sortable="true" field="invoice_number" header="Invoice">
            <template #body="{ data }">
        ...
        <Column :sortable="true" field="posted" header="Posted" />
