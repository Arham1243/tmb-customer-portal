...
const exportMenuItems = [
    {
        ...
        command: () => ''
        // command: () =>
        //     exportData({ table: 'project_activities', format: 'excel' })
    },
    {
        icon: 'pi pi-file-pdf',
        label: 'To PDF',
        command: () => ''
        // command: () =>
        //     exportData({ table: 'project_activities', format: 'pdf' })
    }
];
...
const getItems = async () => {
    try {
        ...
        const res = await projectStore.searchActivities(payload, params);
