...
const emit = defineEmits(['update:selection', 'refresh', 'item-changed']);
...
<template>
    <div>
        ...
        >
            ...
            <Column field="expenseCategory.name">
                <template #header>
            ...
            <Column class="amount-column" field="billable_amount">
                ...
                <template #editor="{ data, field }">
                    <InputField
                        ...
                        :maxFractionDigits="2"
                        :minFractionDigits="2"
                        :disabled="!canEdit || !data.is_billable"
                        class="w-full"
                        inputClass="w-full"
                    />
                </template>
            ...
            <Column field="creditCard.name">
                <template #header>
                    <span class="font-semibold">Card<br />used</span>
                </template>
            </Column>
